...
На выходе ожидается публичный репозиторий (созданный из этого репозитория-шаблона). Все ваши изменения поверх него оформите как пул реквест. И отправьте ссылку на пулреквест на
